    ...
    const sendMessage = () => {
        if(webSocket && webSocket.readyState === WebSocket.OPEN){
            ...
            if(trimmedMessage !== ''){
                ...
                setMessages(prev => [...prev, {type:'sent', message: trimmedMessage}]);      // 최신값(prev) 업데이트
                setMessageInput('');
            }
        }else{
            console.log("웝 소켓이 연결되지 않았습니다.")
        }
    }
            ...
            <div className="chat-container">
                ...
                <div className="input-container">
                    <input
                        ...
                        />
                        <button id="senBtn" onClick={sendMessage}>
                            전송
                        </button>
                        <button onClick={hanleBackToMain}>
                            메인으로 돌아가기
                        </button>
